...

{
  ...
  let steps_img =  atob("GBiBAAcAAA+AAA/AAA/AAB/AAB/gAA/g4A/h8A/j8A/D8A/D+AfH+AAH8AHn8APj8APj8AHj4AHg4AADAAAHwAAHwAAHgAAHgAADAA==");
  ...
  let drawSideBar1=function() {
    ...
    // steps
    g.drawImage(steps_img, w2 + (ws - 64)/2, 0, { scale: 1 });
    setSmallFont();
    g.setFontAlign(0, -1);
